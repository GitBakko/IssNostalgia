...
const PARAMS: Array = [
	...
	["bounce_e_t",                    "e_t (grip tangential)",    0.0,    1.0,    0.005,  "Ground",      "f"],
	["bounce_e_t_surface",            "e_t_surface (Cross 2014)", 0.0,    1.0,    0.005,  "Ground",      "f"],
	["bounce_t_retention_floor",      "v_t retention floor",      0.0,    1.0,    0.005,  "Ground",      "f"],
	["bounce_t_retention_ceil",       "v_t retention ceil",       0.0,    1.0,    0.005,  "Ground",      "f"],
