...
| 2026-05-12 | T03     | Knuckle drift measured 1.159 m / 1.5 s — inside sweet band [0.80, 1.50 m]. No parameter change required. New `test_knuckle_drift.gd` locks the value and seed determinism. Visual validation pending user. |
